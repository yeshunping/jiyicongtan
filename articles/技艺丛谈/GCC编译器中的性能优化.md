...
除了那些会增大代码大小的优化方法，这个特殊的优化级别(-Os, s 是size 的首字母)会打开所有的-O2级别的优化方法。这个级别更强调优化代码大小而不是速度。它包括所有第二级别的优化方法，除了对齐相关的优化。对齐优化浪费了一些空间，以对齐函数、循环、跳转和标签到某个2的幂的倍数的地址，
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTI2MzM3MzI5NywtMTY4NzAzMzg0NiwxMT
